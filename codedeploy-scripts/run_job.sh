...
RESOURCES_PATH=$RESOURCES_PATH REPO_COVID_PATH=$REPO_COVID_PATH /home/ec2-user/./spark-2.4.7-bin-hadoop2.7/bin/spark-submit --class  /home/ec2-user/spark-covid/src/main/ReportsGenerator --master local[*] --jars /home/ec2-user/spark-covid/target/scala-2.11/spark-covid_2.11-1.0.jar
